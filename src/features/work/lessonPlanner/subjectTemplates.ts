...
//  逐科教案範本（內建常數）
//  ------------------------------------------------------------
//  每科 ~3 個範本，反映該科常見課堂形態 / 教學風格；用戶選擇任教科目
//  後，備課時顯示該科範本（直接用 / 給 AI 做骨架）。未知科目 → 通用組。
//  範本 = LessonPlan(objectives) + PlanMeta(phases/materials) 的骨架。
// ============================================================
...
const RAW: RawTpl[] = [
  // ── 經濟 econ ──
  { subjectId: 'econ', name: '概念講授：需求與供應均衡', style: '講授', objectives: '1. 能繪製需求與供應曲線並解釋斜率成因\n2. 能分析影響需求量及需求轉移的因素並以圖表說明均衡變動\n3. 能用理論解釋現實價格現象', phases: [ { label: '引入', minutes: 6, detail: '展示雞蛋價格上升新聞，問「什麼原因令雞蛋貴了？」引出需求/供應轉移分別。' }, { label: '圖表講解', minutes: 15, detail: '白板畫 D、S 曲線，解釋「需求量變」vs「需求變」，示範曲線移動與均衡變化。' }, { label: '時事圖表分析', minutes: 12, detail: '分析香港樓價案例，討論低息、人口、辣招對 D、S 影響，要求繪圖。' }, { label: '即堂練習', minutes: 10, detail: '完成 3 情景題，以圖表說明均衡價量變動方向。' }, { label: '總結', minutes: 7, detail: '歸納影響移動的系統因素，強調圖文並茂作答。' } ], materials: ['需求供應圖表工作紙', '雞蛋/樓市時事節錄', '情景練習題', '因素總結筆記', 'DSE 評分示例'] },
  ...
  { subjectId: 'chin', name: '卷四口語說話：議題討論訓練', style: '說話', objectives: '1. 能就議題提出有條理立場並運用論據\n2. 能在小組討論積極回應、追問\n3. 能流暢表達、避免贅詞', phases: [ { label: '議題引入', minutes: 5, detail: '展示議題卡「中學應否全面 BYOD？」，學生 3 分鐘準備立場。' }, { label: '技巧示範', minutes: 8, detail: '分析卷四示範片段的「引述、反駁、追問」語言表達。' }, { label: '小組討論', minutes: 18, detail: '模擬卷四討論，老師以評估表記錄參與、論點、語言。' }, { label: '觀察反饋', minutes: 10, detail: '針對性口頭反饋：贅詞、切題、回應他人。' }, { label: '個人反思', minutes: 9, detail: '填自我評估表，寫一個改善目標。' } ], materials: ['議題討論卡（5 個）', '卷四評估準則講義', '說話技巧示範片段', '小組觀察評估表', '自我評估反思表'] },
  ...
  // ── 化學 chem ──
  { subjectId: 'chem', name: '概念建構：化學鍵與物質性質', style: '講授', objectives: '1. 區分離子鍵、共價鍵、金屬鍵形成條件\n2. 由鍵型預測熔沸點、導電性、溶解性\n3. 用電負性差判斷鍵型解釋宏觀性質', phases: [ { label: '引入現象', minutes: 6, detail: '展示吃鹽、蠟燭、銅線，問「邊樣導電？邊樣熔點最高？」' }, { label: '概念講解', minutes: 16, detail: '分三段講離子、共價、金屬鍵，配點子模型板書。' }, { label: '引導歸納', minutes: 8, detail: '共同填鍵型比較表，糾正「離子化合物溶水必導電」迷思。' }, { label: '應用練習', minutes: 12, detail: '判斷 MgO、CH₄、Fe、HCl、SiO₂ 鍵型並預測一性質。' }, { label: '總結收結', minutes: 8, detail: '以 SiO₂ 共價晶體破除「高熔點=離子」迷思。' } ], materials: ['吃鹽/石蠟/銅線實物', '化學鍵比較表', '點子模型圖', '應用練習工作紙', 'NaCl 晶格模型'] },
