...
const RAW: RawTpl[] = [
  // ── BAFS 企業、會計與財務概論 ──
  { subjectId: 'bafs', name: '會計概念講授 + 分錄練習', style: '講授', objectives: '1. 能正確理解會計方程式（Assets = Liabilities + Owner’s Equity）及複式記帳原理\n2. 能就簡單商業交易編製日記帳分錄，並過帳至分類帳\n3. 能識別借方（Dr）與貸方（Cr）對各類帳戶嘅影響', phases: [ { label: '引入', minutes: 5, detail: '展示便利店一天收支流水，問學生「點樣記低呢啲數？」，引出複式記帳需要。' }, { label: '概念講解', minutes: 15, detail: '用白板拆解會計方程式，以「購入存貨$5,000現金付款」示範 Dr/Cr 邏輯，配 T 字帳圖示。' }, { label: '示範分錄', minutes: 10, detail: '逐筆示範 5 宗交易嘅日記帳分錄格式，強調日期、帳戶、金額、narration。' }, { label: '課堂練習', minutes: 15, detail: '學生完成工作紙 6 宗交易嘅分錄及過帳，老師巡視糾正 Dr/Cr 反轉等錯誤。' }, { label: '總結', minutes: 8, detail: '用記帳口訣歸納各類帳戶增減規則，預告試算表。' } ], materials: ['T 字帳示範圖卡', '日記帳分錄工作紙（6 宗交易）', '會計方程式掛圖', '帳戶分類速記卡', '便利店收支流水樣本'] },
  { subjectId: 'bafs', name: '真實企業個案研習：商業決策分析', style: '個案', objectives: '1. 能運用 SWOT 框架評估本地中小企內外部環境\n2. 能就個案提出合理市場策略並以商業數據支持\n3. 能用 4P 框架分析個案營銷決策', phases: [ { label: '引入個案', minutes: 7, detail: '派發「本地茶餐廳連鎖化」個案，簡介財務概況，學生速讀。' }, { label: '小組討論', minutes: 15, detail: '小組填 SWOT 表，須引用個案數據（租金佔比、對手定價）支持。' }, { label: '策略建議', minutes: 12, detail: '就「是否開第二分店」用 4P 建議，估算損益平衡點。' }, { label: '匯報交流', minutes: 10, detail: '各組限時匯報，互填同儕評估表。' }, { label: '總結', minutes: 6, detail: '點評各組分析，強調決策須兼顧財務與市場。' } ], materials: ['茶餐廳個案小冊子（含財務數據）', 'SWOT 工作表', '4P 策略框架工作紙', '損益平衡計算指引', '同儕評估表'] },
  { subjectId: 'bafs', name: 'DSE 操卷：財務會計應試技巧', style: '操卷', objectives: '1. 能限時完成 DSE Paper 1 財務報表題並符合格式\n2. 能識別常見陷阱（調整項目、應計與預繳）並正確處理\n3. 能按分值分配作答時間', phases: [ { label: '題型分析', minutes: 8, detail: '展示近 5 年考核分佈，指出損益表 / 資產負債表高頻考點。' }, { label: '限時作答', minutes: 25, detail: '模擬考試完成損益表 + 資產負債表題（含期末調整 4 項）。' }, { label: '對答案', minutes: 10, detail: '逐行解說，示範折舊、壞帳、預繳/應計調整處理。' }, { label: '訂正反思', minutes: 7, detail: '訂正並標注失分類別，追蹤共同弱項。' } ], materials: ['DSE 歷屆財務會計題（3 年）', '模擬試題工作紙', '評分準則參考頁', '失分分析表', '財務報表格式範本'] },
