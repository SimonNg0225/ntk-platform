...
export const EXERCISES: Exercise[] = [
  // ───────── 胸 ─────────
  {
    ...
    formCues: [
      ...
      '雙腳踏實地面，臀部不要離凳（保持五點支撐）',
    ],
    safety:
      '重訓必有保護者或用安全槓，肘不要過度外展成 90° 以免肩前痛；落槓彈胸借力易傷胸肌。',
  },
  {
    id: 'incline-db-press',
  ...
  },
  {
    ...
    formCues: [
      '身體成一直線：頭、髖、腳踭一條線不要塌腰或拱臀',
      '手約肩寬略闊，下放時手肘約 45°（不要完全張開成 T 字）',
      '全程收緊核心同臀部，落到胸口近地面',
    ],
    safety: '塌腰會壓腰椎；肘外張成 90° 增肩關節壓力。撐不住寧可跪姿做全幅度。',
  },
  {
    id: 'cable-fly',
    name: '繩索夾胸（Cable Fly）',
    ...
    formCues: [
      '手肘保持微彎固定角度，動作由肩關節主導（不是屈肘）',
      '想像「抱大樹」向中間收，頂峰夾胸一秒',
      '身體微前傾、核心收緊，不要靠擺動身體借力',
    ],
    safety: '手肘完全伸直會將張力轉到肘關節；重量過大會令肩過度後拉、拉傷胸肌內容來源。',
  },
  ...
  // ───────── 背 ─────────
  {
    ...
    formCues: [
      '起手先沉肩（肩胛下壓），再用背帶起身體',
      '想像手肘向地面、向後拉，胸口靠向槓',
      '頂點下巴過槓，落到手臂接近伸直但不完全放鬆肩',
    ],
    safety: '完全鬆肩懸吊（死掛）易拉傷肩；借擺動（kipping）沒有核心控制易閃腰、傷肩。',
  },
  {
    id: 'bent-over-row',
  ...
  // ───────── 腿 ─────────
  {
    ...
    formCues: [
      ...
      '髖膝同步下蹲，膝向腳尖方向、不要內夾',
      '蹲到至少大腿平行，重心落在腳掌中後段，全程挺胸',
    ],
    safety:
      '膝內扣（valgus）同弓腰係傷膝 / 傷腰高危；務必在深蹲架內設安全桿，量力而為。',
  },
  {
    ...
    safety: '為了落更低而弓背係腰椎受傷主因；活動度不足不要強行加深，先練髖鉸鏈。',
  },
  {
    id: 'lunge',
    name: '弓箭步 / 箭步蹲（Lunge）',
  ...
  },
  {
    ...
    formCues: [
      '手肘微彎固定，舉到手肘與肩同高即可（不用更高）',
      '想像用手肘領舉、不是用手腕，尾指略高似「倒水」',
      '慢慢落、控制離心，不要靠擺身甩起',
    ],
  ...
  // ───────── 核心 ─────────
  {
    ...
    safety: '塌腰令腰椎受壓係最常見錯；撐到發休息塌腰寧可縮短時間，質量行先。',
  },
  {
    id: 'dead-bug',
    name: '死蟲式（Dead Bug）',
  ...
  },
  {
    ...
    safety: '擺盪用慣性會用髖屈肌借力兼閃腰；做不到直腿先屈膝抬。',
  },
  {
    id: 'russian-twist',
    ...
    formCues: [
      '坐姿微後傾、背挺直不要弓，腳可離地增難度',
      '由軀幹（胸椎）旋轉帶動，不只手左右擺',
      '節奏受控，每邊輕觸地或停一停',
    ],
    safety: '弓腰快速亂扭易拉傷下背；重量不用大，受控旋轉先有效。',
  },
