...
//  這裡用一個「並行 meta」集合（key = InboxItem.id）疊加 GTD
//  欄位，不郁共用 schema，向後相容：沒有 meta 的舊項目一律當
//  「未分類 · 未處理」。
// ============================================================
...
export interface KindDef {
  ...
  feature: string | null // useNav 目標功能 id（null = 不提供跳轉）
}
