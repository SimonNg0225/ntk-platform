...
const WORK_TEMPLATES: BuiltinTemplate[] = [
  ...
  },
  {
    ...
    category: '批改',
    title: '擬批改評語',
    body: '以下係已移除姓名／可識別資料嘅學生答案，題目係「{{題目}}」。請擬一段建設性批改評語（指出優點、不足、改善建議），語氣鼓勵。匿名學生答案：\n\n{{匿名學生答案}}',
  },
  {
    id: 'w-rubric',
    category: '批改',
  ...
  },
  {
    ...
    category: '溝通',
    title: '家長跟進訊息',
    body: '幫我草擬一段俾家長嘅跟進訊息。學生情況請只用代號或概括描述，避免姓名／可識別資料：「{{學生情況摘要}}」；希望家長配合：「{{家長可配合事項}}」。請用溫和、具體、非指責語氣，並列出 2 個可行下一步。',
  },
  {
    id: 'w-admin-email',
    category: '行政',
