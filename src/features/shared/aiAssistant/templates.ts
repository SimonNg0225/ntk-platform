...
const LEARNING_TEMPLATES: BuiltinTemplate[] = [
  ...
  },
  {
    ...
    category: '總結',
    title: '總結筆記重點',
    body: '幫我總結以下筆記，輸出：① 3-5 個重點 ② 一句 take-away ③ 2 條可以自測的問題。\n\n{{筆記}}',
  },
  {
    id: 'l-compare',
    category: '總結',
  ...
  },
  {
    ...
    category: '練習',
    title: 'Feynman 自測',
    body: '我會用自己的話解釋「{{概念}}」，你扮不識的人發問同捉漏洞，最後指出我邊度理解有誤。我的解釋：\n\n{{我的解釋}}',
  },
]
...
const WORK_TEMPLATES: BuiltinTemplate[] = [
  ...
  },
  {
    ...
    category: '出題',
    title: 'MC 題',
    body: '就課題「{{課題}}」出 {{題數}} 條 MC 題（4 選項），每題附正確答案同每個選項的解釋（為何正確／錯誤）。',
  },
  {
    id: 'w-structured',
    category: '出題',
  ...
  },
  {
    ...
    category: '教學',
    title: '課堂活動設計',
    body: '為課題「{{課題}}」設計一個 {{時間}} 分鐘的互動課堂活動，包括目標、步驟、分組安排同總結提問。',
  },
  {
    id: 'w-differentiated-worksheet',
    category: '教學',
    title: '分層工作紙',
    body: '為「{{課題}}」設計一份 {{班級／程度}} 適用的分層工作紙，輸出：\n\n1. 基礎題 3 題\n2. 核心題 3 題\n3. 挑戰題 2 題\n4. 每題答案重點\n5. 老師批改時要留意的常見錯誤',
  },
  {
    id: 'w-feedback',
    category: '批改',
    title: '擬批改評語',
    body: '以下是已移除姓名／可識別資料的學生答案，題目是「{{題目}}」。請擬一段建設性批改評語（指出優點、不足、改善建議），語氣鼓勵。匿名學生答案：\n\n{{匿名學生答案}}',
  },
  {
    id: 'w-rubric',
    category: '批改',
    title: '評分準則 (rubric)',
    body: '為「{{任務}}」設計一個 {{等級數}} 級評分準則（rubric），列明每級的描述同分數範圍。',
  },
  {
    id: 'w-parent',
    category: '溝通',
    title: '家長通訊草稿',
    body: '幫我草擬一段給家長的訊息：關於「{{事項}}」，語氣專業有禮，重點清晰。',
  },
  {
    id: 'w-parent-followup',
    category: '溝通',
    title: '家長跟進訊息',
    body: '幫我草擬一段給家長的跟進訊息。學生情況請只用代號或概括描述，避免姓名／可識別資料：「{{學生情況摘要}}」；希望家長配合：「{{家長可配合事項}}」。請用溫和、具體、非指責語氣，並列出 2 個可行下一步。',
  },
  {
    id: 'w-admin-email',
    category: '行政',
