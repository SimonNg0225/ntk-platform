...
i18n.addResourceBundle(
  ...
  'translation',
  {
    aiasst: {
      ...
      gateNotEnabledHint: 'AI features are not enabled for this workspace yet. Contact an admin or support to finish setup.',
      gateTestMode: 'Preview AI interface',
      ...
      contextTooltip: 'Add notes or files as references',
      context: 'References',
      ...
      // Composer
      composerPlaceholder: 'Enter a topic, request, or paste content…',
      templateLibrary: 'Task templates',
      templateLibraryTooltip: 'Task templates ({{mod}}/)',
      linkContext: 'Add references',
      ...
      tplPromptLibrary: 'Task templates',
      ...
      tplEmptyMineHint: 'Save frequent requests to reuse them in one click.',
      ...
      // 上下文 Modal
      ctxLinkTitle: 'Add reference material',
      ctxIntro: 'Pick notes or records as references; the assistant will prioritise connecting its answers to them. {{count}} selected.',
      ctxTabNote: 'Notes',
      ...
      ctxFreeBodyPlaceholder: 'Paste the text you want the assistant to reference…',
      ctxFreeDefaultTitle: 'Free text',
      ctxAddContext: 'Add reference',
      ctxSelected: 'Selected:',
      ctxRemove: 'Remove: {{title}}',
      ctxRemoveChip: 'Remove reference: {{title}}',
      ctxToastEmpty: 'Content cannot be empty',
      ctxToastAdded: 'Reference added',
      ...
      paletteActionCtx: 'Add references',
