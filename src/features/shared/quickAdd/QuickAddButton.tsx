...
//  在 App 主內容區用 absolute 定位在右上方角，不擋「← 返回概覽」同標題
//  （見 App.tsx 接線）。
// ============================================================
