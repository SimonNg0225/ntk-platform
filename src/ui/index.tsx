        ...
        {title && (
          <div className="mb-4 flex items-center justify-between">
            ...
            <button
              onClick={onClose}
              type="button"
              className="inline-flex h-11 w-11 items-center justify-center rounded-lg text-slate-400 transition hover:bg-slate-100 hover:text-slate-600 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-accent/40 dark:hover:bg-slate-700"
              aria-label="關閉"
            >
              <X size={18} />
            </button>
...
export function IconButton({
  ...
  return (
    <button
      ...
      disabled={disabled}
      className={cx(
        'inline-flex min-h-11 min-w-11 items-center justify-center rounded-xl transition duration-150 active:scale-95 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-accent/40 focus-visible:ring-offset-1 focus-visible:ring-offset-white disabled:cursor-not-allowed disabled:opacity-40 dark:focus-visible:ring-offset-slate-900',
        size === 'sm' ? 'p-2' : 'p-2.5',
        active
