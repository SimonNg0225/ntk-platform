...
export const appEn = {
  ...
  feat: {
    ...
    'work-ai': { name: 'Assistant chat', desc: 'Continue from a teaching assistant prompt, then refine and generate.' },
    'work-prompt-library': { name: 'Teaching assistant', desc: 'Choose an assistant by job: email, lesson prep, questions, feedback, slides, parent follow-up and admin.' },
  ...
  slides: {
    editTitle: 'Edit slide {{n}}',
    undo: 'Undo once',
    cancel: 'Cancel',
    save: 'Save slide',
    fTitle: 'Slide title',
    fBullets: 'Bullets (one per line; backup / handout)',
    fStats: 'Big numbers (2-4)',
    statValue: 'Value',
    statLabel: 'Label',
    colTitle: 'Column title',
    colItems: 'One point per line (2-4)',
    fSteps: 'Steps (2-5)',
    stepTitle: 'Step name',
    stepDesc: 'Detail (optional)',
    fQuote: 'Quote (≤60 chars)',
    fAttribution: 'Attribution (optional)',
    fCards: 'Cards (2-6)',
    cardTitle: 'Card title',
    cardDesc: 'Detail (optional)',
    fSubtitle: 'English subtitle (optional)',
    fImageQuery: 'Photo search terms (optional)',
    fTakeaway: 'Takeaway (optional, ≤40 chars; rendered as bottom band)',
    fNotes: 'Speaker notes (optional)',
    fChart: 'Data chart (optional)',
    addChart: 'Add chart',
    removeChart: 'Remove chart',
    chartBar: 'Bar',
    chartLine: 'Line',
    chartPie: 'Pie',
    chartUnit: 'Unit (optional, e.g. %)',
    chartSeries: 'Series name',
    chartCats: 'Labels (separated by 、)',
    chartVals: 'Values (separated by 、, same count as labels)',
    chartInvalid: 'Values must be numbers; labels and values cannot be empty',
    addRow: 'Add row',
    removeRow: 'Remove row',
    aiHint: 'Instruction (optional): e.g. "simpler, for Form 1"',
    aiRewrite: 'AI rewrite',
    aiConvert: 'AI re-layout',
    aiConvertHint: 'Rule conversion not pretty? Let AI restructure into this layout',
    aiDone: 'AI updated — you can keep editing',
    aiFail: 'AI failed; slide unchanged',
  },
}
