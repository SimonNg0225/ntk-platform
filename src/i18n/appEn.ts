...
export const appEn = {
  ...
  feat: {
    ...
    'work-classroom-pack': { name: 'Classroom pack', desc: 'Enter one topic to create a consistent lesson plan, worksheet and presentation, ready to edit and review.' },
    'work-ai': { name: 'Assistant chat', desc: 'Continue from a teaching assistant prompt, then refine and generate.' },
    'work-voice-assistant': { name: 'Ezi assistant', desc: 'Speak a goal, review the plan, and let Ezi carry out approved teaching tasks across the workspace.' },
