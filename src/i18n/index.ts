  ...
  'zh-HK': {
    translation: {
      ...
      f: {
        ...
        aiTitle: 'AI 出題、試卷與簡報',
        aiDesc: '輸入課題即生成 MC／短答／長題與工作紙；更可一鍵生成 PowerPoint 教學簡報 —— 24 套設計模板，版式與配圖自動排好。',
        gradeTitle: '批改 · 成績 · 評語',
  ...
  en: {
    translation: {
      ...
      f: {
        ...
        aiDesc: 'Type a topic to generate MC / short / long questions and worksheets — or one-click a PowerPoint lesson deck with 24 design templates, auto-matched layouts and photos.',
