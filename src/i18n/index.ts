...
//  的逐字 i18n 屬漸進工作（已建立 t() 模式，後續按 namespace 擴充）。
// ============================================================
  ...
  'zh-HK': {
    translation: {
      ...
      f: {
        ...
        attTitle: '課堂與班務',
        attDesc: '時間表、待辦、行事曆、重要日子倒數與課堂任務整理，幫你上堂前後少些切換。',
        commTitle: '行政、文件與溝通',
      ...
      proof: {
        eyebrow: '散戶先行',
        quote: '先令一位老師覺得「今晚真的幫到我」，科組和學校級 adoption 才有自然發生的理由。',
      ...
      faq: {
        eyebrow: '常見問題',
        title: '先解答購買前會問的事',
        sub: '教育產品最怕「看起來好用，但不敢真的放進日常」。這裡把私隱、收費、資料和 AI 責任先說清楚楚。',
        school: {
          q: '一定要學校採購先用到嗎？',
      ...
      legal: {
        updatedLabel: '最後更新：',
        disclaimer:
          '本頁內容僅供一般參考，不構成法律意見；如中英文版本有歧義，以中文版為準。',
      },
      ...
      cookie: {
        region: 'Cookie 同意',
        text: '我們用分析 cookie 改善產品體驗。你可以選擇接受或拒絕；詳情見',
        privacy: '私隱政策',
        textEnd: '。',
        reject: '拒絕',
        accept: '接受',
      ...
      privacy: {
        ...
        intro:
          `${BRAND_NAME}（「本平台」）尊重並保障你的個人資料私隱。本政策說明我們會收集什麼資料、如何使用及保護，以及你擁有的權利。本平台主要為香港教育工作者而設，會按香港《個人資料（私隱）條例》（第 486 章）行事。`,
        s1Title: '我們收集的資料',
        s1AccountLabel: '帳戶資料',
        s1Account: '：你用 Google 登入時提供的名稱同電郵地址。',
        s1InputLabel: '你輸入的內容',
        s1Input:
          '：筆記、教案、題目、成績分析輸入、班務記錄等教學內容。預設只存在你裝置的瀏覽器（localStorage）；登入後會同步到我們的雲端供應商 Supabase。如需處理學生相關資料，建議使用學生編號或代號，並避免輸入可識別學生資料。',
        s1AiLabel: 'AI 請求',
        s1Ai: '：你使用教學 AI 時輸入的文字／圖片，會經我們的伺服器代理送往 Google Gemini 處理，用以生成回應。',
        s1PayLabel: '付款資料',
        s1PayPre: '：訂閱由 Stripe 處理；我們',
        s1PayStrong: '不會',
        s1PayPost: '儲存你的信用卡號碼。',
        s1AnalyticsLabel: '分析與診斷',
        s1AnalyticsPre: '：在你',
        s1AnalyticsStrong: '同意',
        s1AnalyticsPost: '後，我們會用 PostHog 收集匿名使用統計；並用 Sentry 收集錯誤報告以改善穩定性。',
        s2Title: '使用目的',
        s2Pre: '提供及維運平台功能、雲端同步、處理訂閱、改善產品體驗、保障系統安全及履行法律責任。我們',
        s2Strong: '不會',
        s2Post: '出售你的個人資料。',
        s3Title: '第三方服務',
        s3Body:
        ...
        s4Title: '資料儲存與保安',
        s4Body:
          '雲端資料以行級安全（RLS）隔離，確保每位用戶只可存取自己的資料。部分服務商位於香港境外，你的資料可能會傳輸並儲存在境外，我們會採取合理措施確保有適當保障。我們採取合理技術措施保護資料，但互聯網傳輸無法保證絕對安全。',
        s5Title: '你的權利',
        s5Body:
          '你可隨時在「設定」匯出或清除本機資料，亦可要求查閱、更正或刪除我們持有的個人資料。你可在 Cookie 橫額或瀏覽器設定撤回分析同意。',
        s6Title: 'Cookie 與分析',
        s6Body: '我們只在你「接受」後才載入分析 cookie。拒絕不會影響核心功能。錯誤監控屬維持服務之正當利益。',
        s7Title: '兒童',
        s7Body:
          '平台供教師專業使用，不面向兒童。若教師在成績、班務或課堂紀錄工具輸入學生相關資料，須按學校政策及適用法律處理，並應盡量使用代號或遮蔽可識別資料；我們不會主動向兒童收集個人資料。',
        s8Title: '聯絡我們',
      ...
      terms: {
        ...
        s1Title: '服務說明',
        s1Body:
          '本平台為香港教師提供備課、出題、成績管理、班務跟進、對外訊息初稿、行政文件及 AI 教學助手等工具。我們可能不時更新、增刪功能。',
        s2Title: '帳戶',
        s2Body:
        ...
        s6Title: '你的資料、內容與分享',
        s6Body:
          '你保留對自己輸入內容的權利。你授權我們為提供服務所需而處理及儲存有關內容（包括雲端同步及 AI 處理）。當你在資源分享區或老師社群分享內容，即表示你確認你擁有或有權分享該內容，並授予其他用戶為教學／非商業用途下載及使用該內容的非專屬、可撤回授權；你可隨時移除你分享的內容。社群行為守則詳見《社群守則》，資料處理詳見私隱政策。',
        s7Title: '知識產權',
        s7Body: '平台之軟件、設計及商標屬本平台或其授權人所有，未經許可不得複製或再分發。',
        s8Title: '免責聲明與責任限制',
        s8Body:
          '本平台按「現狀」提供，不就特定用途之適用性作任何明示或默示保證。在適用法律允許之最大範圍內，我們不就任何間接或後果性損失承擔責任。',
        s9Title: '終止',
        s9Body: '你可隨時停止使用並刪除資料。若你嚴重違反本條款，我們可暫停或終止你的帳戶。',
        s10Title: '條款修改',
        s10Body: '我們可不時更新本條款，並在本頁公布更新日期。重大變更會盡量另行通知。',
        s11Title: '適用法律',
      ...
      guidelines: {
        ...
        updated: '2026 年 6 月 13 日',
        intro:
          `${BRAND_NAME} 的資源分享區同老師社群論壇，係給全港老師交流教學資源同經驗的地方。為了保持一個專業、互信、友善的環境，請遵守以下守則。本守則構成《服務條款》的一部分；違反者我們可移除內容、發出警告或暫停帳戶。`,
        s1Title: '尊重同專業',
        s1Body:
          '以禮待人、就事論事。嚴禁人身攻擊、騷擾、歧視、仇恨言論或任何形式的欺凌。歡迎理性討論同表達不同意見，但不要針對個人。',
        s2Title: '分享資源的版權',
        s2Body:
          '只可分享你自己創作、或你有權分享的內容。請尊重版權 —— 不要上載出版社教科書、未經授權的試題或答案、考評局（HKEAA）版權材料等。上載時如實標示授權（「原創」或「可分享」），並確保你有權授予其他老師下載及課堂使用。',
        s3Title: '保護學生私隱',
        s3Body:
          '不要上載含可識別學生個人資料的內容（姓名、相片、成績、學生作品等），除非已遮蔽處理或取得適當同意。處理學生資料須符合所屬學校政策及香港《個人資料（私隱）條例》。',
        s4Title: '內容要切題、有質素',
        s4Body:
          '請分享同教學相關的資源同討論。不要洗版、賣廣告、招攬生意、重覆張貼，或發布與教學無關的內容。',
        s5Title: '禁止內容',
        s5Body:
          '嚴禁違法、侵權、淫穢、暴力、虛假誤導、含惡意程式或連結的內容，以及任何洩露未公開試題或違反保密協議的材料。',
        s6Title: '檢舉與處理',
        s6Body:
          '見到違規內容，可用每項資源或帖子的「檢舉」功能通知我們。我們會檢視並按情況移除內容、發出警告，或暫停／終止帳戶。即使以匿名分享，管理員仍可追溯帳戶以防濫用。',
        s7Title: '匿名分享',
        s7Body:
          '你可選擇匿名分享，公開只顯示「匿名老師」。匿名不等於免責 —— 你仍須對所分享內容負責，本守則一樣適用。',
        s8Title: '內容免責',
        s8Body:
          `${BRAND_NAME} 不保證社群資源的準確性、完整性或適用性。用於課堂或評估前，請自行專業判斷及覆核。`,
        s9Title: '守則修改',
        s9Body:
          '我們可不時更新本守則，並在本頁公布更新日期。重大變更會盡量另行通知。如有查詢，請見《服務條款》的聯絡方式。',
      },
      ...
      settings: {
        ...
        subjects: '任教科目',
        subjectsHint:
          '選擇你的任教科目，載入起始課題大綱；教學 AI 亦會以此科為語境。課題之後可在「課程進度」自行增刪改。',
        dataOverview: '我的資料一覽',
        dataOverviewHint: '查看本機儲存了多少資料，匯出備份前心裡有數。',
        dataManagement: '資料管理',
        dataManagementHint: '你的資料目前儲存在此裝置的瀏覽器。定期匯出備份，或者在換機時匯入。',
        appUpdate: '應用程式更新',
        appUpdateHint:
          '部署了新版但見不到更新？可手動檢查；或清除快取強制載入最新版（你的資料不受影響）。',
        legalTitle: '法律、私隱與支援',
        legalHint:
          '服務條款、私隱政策、社群守則、定價與支援集中放在這裡；處理學生相關資料前，建議先使用代號或遮蔽可識別資料。',
        legalLinks: {
          privacy: '私隱政策',
          terms: '服務條款',
          guidelines: '社群守則',
