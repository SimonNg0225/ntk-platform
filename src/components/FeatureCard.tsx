...
export default function FeatureCard({ feature, onOpen }: Props) {
  return (
    <button
      ...
      className="group flex flex-col items-start rounded-3xl border border-slate-200/80 bg-white p-5 text-left shadow-sm transition hover:-translate-y-1 hover:border-accent/40 hover:shadow-lg hover:shadow-accent/5"
    >
