...
const MATH: OutlineRow[] = [
  [CORE, '數與代數', '方程、不等式與函數圖像'],
  [CORE, '數與代數', '指數、對數與多項式'],
  [CORE, '數與代數', '等差與等比數列'],
  [CORE, '數與代數', '變分（正 / 反 / 聯 / 部分變）'],
  [CORE, '數與代數', '百分法的應用（複利 / 增長折舊）'],
  [CORE, '度量、圖形與空間', '量度與誤差、坐標幾何'],
  [CORE, '度量、圖形與空間', '三角學（2D / 3D 應用）'],
  [CORE, '度量、圖形與空間', '圓的性質與軌跡'],
  [CORE, '數據處理', '統計圖表與離差（含標準差）'],
  [CORE, '數據處理', '概率與排列組合'],
]

const CSD: OutlineRow[] = [
  ['主題一', '「一國兩制」下的香港', '政治體制、《基本法》與法治'],
  ['主題一', '「一國兩制」下的香港', '發展機遇與挑戰（大灣區 / 一帶一路 / 民生）'],
  ['主題一', '「一國兩制」下的香港', '香港社會的多元文化特徵'],
  ['主題二', '改革開放以來的國家', '改革開放的歷程與成就'],
  ['主題二', '改革開放以來的國家', '綜合國力提升與國際地位'],
  ['主題三', '互聯相依的當代世界', '經濟全球化與相互依存'],
  ['主題三', '互聯相依的當代世界', '科技發展與資訊素養'],
  ['主題三', '互聯相依的當代世界', '公共衞生與人類健康'],
  ['主題三', '互聯相依的當代世界', '可持續發展'],
  ['答題技巧', '資料回應題', '資料解讀、推斷與多角度論證'],
]
