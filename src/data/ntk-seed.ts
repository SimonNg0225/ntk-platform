...
//  ------------------------------------------------------------
//  · 由 NTK 提供的教師時間表 + 校曆相片轉錄。
//  · cycle day A=1 … F=6，直接對上 TimetableSlot.day（不用改模型）。
//  · 用作 collection 預設值：collection 一旦係空就 seed 這批；用家改過就不覆寫。
//  · 校曆暫只入有信心那段（2026-06-01 ~ 06-18，正常上課週）；
...
export const NTK_SLOTS: TimetableSlot[] = [
  // Day B (2)
  L(2, 1, 'S6 L1 · 高中課', '56'), L(2, 2, 'S6 L1 · 高中課', '56'),
  L(2, 3, 'S6 L3 · 高中課', '56'), L(2, 4, 'S6 L3 · 高中課', '56'),
  L(2, 5, 'S6 L1 · 高中課', '56'), L(2, 6, 'S6 L1 · 高中課', '56'),
  L(2, 7, 'S5 L1 · 高中課', '52'), L(2, 8, 'S5 L1 · 高中課', '52'),
  // Day C (3)
  L(3, 3, 'S5 L3 · 高中課', '52'), L(3, 4, 'S5 L3 · 高中課', '52'),
  L(3, 5, 'S6 L1 · 高中課', '56'), L(3, 6, 'S6 L1 · 高中課', '56'),
  L(3, 7, 'S5 L1 · 高中課', '52'), L(3, 8, 'S5 L1 · 高中課', '52'),
  // Day D (4)
  L(4, 3, '3A · 初中課', '25'), L(4, 5, '3A · 初中課', '25'),
  L(4, 7, 'S5 L1 · 高中課', '52'), L(4, 8, 'S5 L1 · 高中課', '52'),
  // Day E (5)
  L(5, 3, 'S6 L3 · 高中課', '56'), L(5, 4, 'S6 L3 · 高中課', '56'),
  L(5, 7, 'S5 L3 · 高中課', '52'), L(5, 8, 'S5 L3 · 高中課', '52'),
  // Day F (6)
  L(6, 1, 'S6 L3 · 高中課', '56'), L(6, 2, 'S6 L3 · 高中課', '56'),
  L(6, 5, 'S5 L3 · 高中課', '52'), L(6, 6, 'S5 L3 · 高中課', '52'),
  L(6, 8, '3A · 班務', '25'),
]
