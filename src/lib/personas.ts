...
//  build-time 生成（scripts/gen-personas.mjs）。資料在 personas.generated.ts，
//  SVG 在 public/personas/<id>.svg。這裡只加查詢 / 分組輔助，UI 統一由此 import。
// ============================================================
